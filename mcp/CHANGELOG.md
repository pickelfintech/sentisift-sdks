...
- Switched the SDK license from a custom proprietary license to standard **MIT** (matches industry default for B2B API client libraries). The SentiSift API service itself is unchanged and remains governed by https://sentisift.com/terms.html. No code changes in this release.
